...
?>
  ...
  <head>
    ...
    <title>UMS - PACS</title>
    <link href="css/bootstrap/css/bootstrap.css" rel="stylesheet">
    <link href="css/jquery-ui/jquery-ui.min.css" rel="stylesheet">
    <link href="css/pdp/css/persian-datepicker.min.css" rel="stylesheet">
  ...
  <body>
    ...
    <div id="main-container" class="container-fluid full-height">
      ...
      <?php include('study-section.php'); ?>
      <?php include('series-section.php'); ?>
    </div>
    ...
    <script src="css/pdp/js/persian-datepicker.min.js"></script>
